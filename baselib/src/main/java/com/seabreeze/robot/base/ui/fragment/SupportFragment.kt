...
abstract class SupportFragment<out Presenter : BasePresenter<BaseView<Presenter>>, VB : ViewBinding> :
    BaseMvpFragment<Presenter, VB>(), BaseView<Presenter>, ISupportFragment {
