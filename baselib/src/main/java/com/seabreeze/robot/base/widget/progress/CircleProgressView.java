package com.seabreeze.robot.base.widget.progress;
 ...
 * | progressBriefTextSize | 进度值上方文字相关
 * | progressBriefTextColor | 进度值上方文字相关
 * progressBriefText
 * </pre>
 */
public class CircleProgressView extends View {
    ...
    private int mProgressBriefTextSize = 48;

    private String mProgressBriefText = "";
    /**
     * the color of inner text
     */
    private int mProgressTextColor = getResources().getColor(R.color.colorAccent);

    private int mProgressBriefTextColor = getResources().getColor(R.color.colorAccent);
    /**
    ...
    private void obtainAttrs(Context context, AttributeSet attrs) {
        ...
        mProgressBriefText = typedArray.getString(R.styleable.CircleProgressView_progressBriefText);
        ...
        mProgressBriefTextColor = typedArray.getColor(R.styleable.CircleProgressView_progressBriefTextColor, getResources().getColor(R.color.colorAccent));
        ...
        mProgressBriefTextSize = typedArray.getDimensionPixelSize(R.styleable.CircleProgressView_progressBriefTextSize, getResources().getDimensionPixelSize(R.dimen.default_progress_brief_text_size));
    ...
    private void drawProgressText(Canvas canvas) {
        ...
        if (textVisibility) {
            ...
            mBriefTextPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
            mBriefTextPaint.setStyle(Paint.Style.FILL);
            mBriefTextPaint.setTextSize(mProgressBriefTextSize);
            mBriefTextPaint.setColor(mProgressBriefTextColor);
            mBriefTextPaint.setTextAlign(Paint.Align.CENTER);

            float textHeight = mTextPaint.descent() + mTextPaint.ascent();
            float distance = mBriefTextPaint.descent() + mBriefTextPaint.ascent();

            float x = (getWidth() + getPaddingLeft() - getPaddingRight()) >> 1;
            float y;
            if (TextUtils.isEmpty(mProgressBriefText)) {
                //不绘制上方文字
                y = (getHeight() + getPaddingTop() - getPaddingBottom() - textHeight) / 2;
            } else {
                //绘制文字
                canvas.drawText(mProgressBriefText, x, ((getHeight() + getPaddingTop() - getPaddingBottom()) >> 1) + distance, mBriefTextPaint);
                //moveProgress下移
                y = (getHeight() + getPaddingTop() - getPaddingBottom() - textHeight) / 2 - distance;
            }
...
//            float y = (getHeight() + getPaddingTop() - getPaddingBottom() - (mTextPaint.descent() + mTextPaint.ascent())) / 2;
    ...
    public void setScaleZoneWidth(float zoneWidth) {
        this.mScaleZoneWidth = dp2px(mContext, (int) zoneWidth);
    }
    ...
    public void setScaleZoneLength(float zoneLength) {
        this.mScaleZoneLength = dp2px(mContext, (int) zoneLength);
    }
    ...
    public void setScaleZonePadding(int zonePadding) {
        this.mScaleZonePadding = dp2px(mContext, zonePadding);
    }
    ...
    public void setScaleZoneCornerRadius(int cornerRadius) {
        this.mScaleZoneCornerRadius = dp2px(mContext, cornerRadius);
    }
    ...
    public void setProgressBriefText(String brief) {
        this.mProgressBriefText = brief;
        refreshTheView();
    }
