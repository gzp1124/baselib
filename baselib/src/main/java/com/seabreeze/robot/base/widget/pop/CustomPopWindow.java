package com.seabreeze.robot.base.widget.pop;
...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
    ...
    public CustomPopWindow showAtLocation(int gravity, int x, int y) {
        if (mPopupWindow != null && mContentView != null) {
            showAtLocation(mContentView, gravity, x, y);
        }
        return this;
    }
            ...
            mPopupWindow.setTouchInterceptor(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if ((event.getAction() == MotionEvent.ACTION_DOWN)
                        ...
                        XLog.e(TAG, "out side ");
                        XLog.e(TAG, "width:" + mPopupWindow.getWidth() + "height:" + mPopupWindow.getHeight() + " x:" + x + " y  :" + y);
                        return true;
