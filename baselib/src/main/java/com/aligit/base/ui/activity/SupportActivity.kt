 ...
 * </pre>
 */
abstract class SupportActivity<out Presenter : BasePresenter<BaseView<Presenter>>, VB : ViewBinding> :
    BaseMvpActivity<Presenter, VB>(), BaseView<Presenter>, ISupportActivity {
